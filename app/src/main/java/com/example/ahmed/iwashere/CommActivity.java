...
public class CommActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Uri bitmap = (Uri) intent.getExtras().get("photo");
        LatLng curr = (LatLng) intent.getExtras().get("location");
        Picasso.with(getApplicationContext()).load(bitmap).fit().into(image);
